...
/**
 * [group_name_change 群名称变更事件](https://milky.ntqqrev.org/struct/Event#type-group_name_change).
 *
 * @see love.forte.simbot.milky.model.event.MilkyRawEvent
 */
@Serializable
@SerialName(MilkyRawGroupNameChangeEventData.SERIAL_NAME)
@MilkyRawEventDataMarker(eventType = MilkyRawGroupNameChangeEventData.EVENT_TYPE)
public data class MilkyRawGroupNameChangeEventData
...
internal constructor(
     ...
     * 新的群名称
     */
    @SerialName("new_group_name")
    public val newGroupName: String,
    /**
     * 操作者 QQ 号
     */
    ...
    public companion object {
        public const val EVENT_TYPE: String = "group_name_change"
