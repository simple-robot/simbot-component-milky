...
/**
 * [group_file_upload 群文件上传事件](https://milky.ntqqrev.org/struct/Event#type-group_file_upload).
 *
 * @see love.forte.simbot.milky.model.event.MilkyRawEvent
 */
@ConsistentCopyVisibility
@Serializable
@SerialName(MilkyRawGroupFileUploadEventData.SERIAL_NAME)
@MilkyRawEventDataMarker(eventType = MilkyRawGroupFileUploadEventData.EVENT_TYPE)
public data class MilkyRawGroupFileUploadEventData
...
internal constructor(
    ...
    public companion object {
        public const val EVENT_TYPE: String = "group_file_upload"
