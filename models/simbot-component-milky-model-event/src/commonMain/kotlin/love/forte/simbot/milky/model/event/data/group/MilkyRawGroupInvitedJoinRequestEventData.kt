...
/**
 * [group_invited_join_request 群成员邀请他人入群请求事件](https://milky.ntqqrev.org/struct/Event#type-group_invited_join_request).
 *
 * @see love.forte.simbot.milky.model.event.MilkyRawEvent
 */
@ConsistentCopyVisibility
@Serializable
@SerialName(MilkyRawGroupInvitedJoinRequestEventData.SERIAL_NAME)
@MilkyRawEventDataMarker(eventType = MilkyRawGroupInvitedJoinRequestEventData.EVENT_TYPE)
public data class MilkyRawGroupInvitedJoinRequestEventData
...
internal constructor(
    ...
    public companion object {
        public const val EVENT_TYPE: String = "group_invited_join_request"
