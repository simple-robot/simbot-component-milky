 ...
 */
@Serializable
public class MilkySendPrivateMessageParam(
    /**
     * 好友 QQ 号
     */
    @SerialName("user_id")
     ...
     * 消息内容
     */
    public val message: List<MilkyOutgoingSegment>,
) : MilkyApiParamModel {
    override fun toString(): String {
        return "MilkySendPrivateMessageParam(userId=$userId, message=$message)"
    }
}
