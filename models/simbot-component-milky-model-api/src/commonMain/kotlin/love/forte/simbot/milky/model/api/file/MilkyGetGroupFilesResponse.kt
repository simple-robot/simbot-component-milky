...
import love.forte.simbot.milky.model.entity.group.MilkyRawGroupFileEntity
import love.forte.simbot.milky.model.entity.group.MilkyRawGroupFolderEntity
 ...
 */
@Serializable
public data class MilkyGetGroupFilesResponse
@MilkyApiModelConstructor private constructor(
    /**
     * 文件列表
     */
    val files: List<MilkyRawGroupFileEntity>,
    /**
     * 文件夹列表
     */
    val folders: List<MilkyRawGroupFolderEntity>,
