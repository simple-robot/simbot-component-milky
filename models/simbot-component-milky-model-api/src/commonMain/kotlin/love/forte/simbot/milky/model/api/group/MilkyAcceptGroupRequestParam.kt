 ...
 */
@Serializable
public class MilkyAcceptGroupRequestParam(
    /**
     * 请求对应的通知序列号
     */
    ...
    override fun toString(): String {
        return "MilkyAcceptGroupRequestParam(notificationSeq=$notificationSeq, notificationType=$notificationType, groupId=$groupId, isFiltered=$isFiltered)"
    }
}
